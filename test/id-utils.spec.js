...
test('parse parses id', t => {
  ...
  t.deepEqual(parse('a//./b.js'), {prefix: '', bareId: 'a/b', parts: ['a', 'b'], ext: '', cleanId: 'a/b'});
  t.deepEqual(parse('a/../..//foo/a/b.min.js'), {prefix: '', bareId: '../foo/a/b.min', parts: ['..', 'foo', 'a', 'b.min'], ext: '', cleanId: '../foo/a/b.min'});
  t.deepEqual(parse('a/../a/b.min.js'), {prefix: '', bareId: 'a/b.min', parts: ['a', 'b.min'], ext: '', cleanId: 'a/b.min'});
...
test('parse parses id with plugin prefix', t => {
  ...
  t.deepEqual(parse('text!a/b.js'), {prefix: 'text!', bareId: 'a/b', parts: ['a', 'b'], ext: '', cleanId: 'text!a/b'});
  t.deepEqual(parse('text!a/b.min.js'), {prefix: 'text!', bareId: 'a/b.min', parts: ['a', 'b.min'], ext: '', cleanId: 'text!a/b.min'});
...
test('parse parses id with scope', t => {
  ...
  t.deepEqual(parse('@s//a///b.js'), {prefix: '', bareId: '@s/a/b', parts: ['@s/a', 'b'], ext: '', cleanId: '@s/a/b'});
  t.deepEqual(parse('@s/a/b.min.js'), {prefix: '', bareId: '@s/a/b.min', parts: ['@s/a', 'b.min'], ext: '', cleanId: '@s/a/b.min'});
...
test('relativeModuleId returns relative module id', t => {
  ...
  t.equal(relativeModuleId('base', './foo//bar.js'), './foo/bar');
  t.end();
});
...
test('relativeModuleId returns clean id', t => {
  t.equal(relativeModuleId('base', 'foo.js'), './foo');
  t.equal(relativeModuleId('base', 'foo.json'), './foo.json');
  t.equal(relativeModuleId('base/bar', 'base/foo.js'), './foo');
  t.equal(relativeModuleId('base/bar', 'foo.html'), '../foo.html');
  t.equal(relativeModuleId('@scope/base', 'foo.js'), './foo');
  t.equal(relativeModuleId('@scope/base', 'foo.json'), './foo.json');
  t.equal(relativeModuleId('@scope/base', 'text!foo.js'), 'text!./foo');
  t.equal(relativeModuleId('@scope/base', 'text!../foo.html'), 'text!../foo.html');
  t.equal(relativeModuleId('@scope/base/bar', 'text!@scope/base/foo.js'), 'text!./foo');
